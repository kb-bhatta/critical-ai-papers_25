...
"Deep Residual Learning for Image Recognition" (2015) by Kaiming He et al.
...
"AlphaFold 2 and the Future of AI-Assisted Protein Structure Prediction" (2020) by John Jumper et al.
...
Link: AlphaFold 2 and the Future of AI-Assisted Protein Structure Prediction

"Scaling Vision Transformers to 22 Billion Parameters" (2024) by Xianzhi Du et al.
...
Link: Scaling Vision Transformers to 22 Billion Parameters

"AlphaMissense: AI System for Predicting the Pathogenicity of Genetic Variants" (2024) by Pushmeet Kohli et al.
...
Link: AlphaMissense: AI System for Predicting the Pathogenicity of Genetic Variants

"Mamba: A Memory-Augmented Model for Efficient AI" (2024) by Albert Gu and Tri Dao
...
Link: Mamba: A Memory-Augmented Model for Efficient AI

"Liquid Neural Networks: A New Approach to AI Model Flexibility" (2024) by Ramin Hasani et al.
...
Link: Liquid Neural Networks: A New Approach to AI Model Flexibility

GPT-3 Release, OpenAI
...
Link: Language Models are Few-Shot Learners

"Chain-of-Thought Prompting Elicits Reasoning in Large Language Models" (2022) by Jason Wei et al.
...
Link: Chain-of-Thought Prompting Elicits Reasoning in Large Language Models

"Self-Consistency Improves Chain of Thought Reasoning in Language Models" (2022) by Xuezhi Wang et al.
...
Link: Self-Consistency Improves Chain of Thought Reasoning in Language Models

"ChatGPT: Optimizing Language Models for Dialogue," published on November 30, 2022
